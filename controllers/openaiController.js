...
const generateAnswer = async (req, res) => {
  ...
  try {
    let prompt = `Answer in first person for this a question about Rishit's resume: "${question}" Focus on the specific project/experience and provide a short summary. Make sure to use paragraphs and be straight to the point. Here is the relevant excerpt from the resume:
